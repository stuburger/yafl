...
function wrapConsumer(Consumer) {
    ...
    return /** @class */ (function (_super) {
        ...
        FormField.prototype.componentDidUpdate = function (pp) {
            var _a = this.props.validators, validators = _a === void 0 ? emptyArray : _a;
...
function isDirty(field) {
    return !utils_1.isEqual(field.originalValue, field.value);
}
