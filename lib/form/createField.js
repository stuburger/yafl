    ...
    return /** @class */ (function (_super) {
        ...
        function FormField() {
            ...
            _this._render = function (_a) {
                ...
                var state = loaded && value[name] ? value[name] : defaultFieldState;
                var validation = loaded && value[name] ? providerValue.validation[name] : emptyArray;
                return (React.createElement(InnerField, __assign({}, state, props, { name: name, render: render, component: component, validation: validation, validators: validators, submit: providerValue.submit, unload: providerValue.unload, clearForm: providerValue.clearForm, submitting: providerValue.submitting, forgetState: providerValue.forgetState, submitCount: providerValue.submitCount, onFieldBlur: providerValue.onFieldBlur, setFieldValue: providerValue.setFieldValue, registerField: providerValue.registerField, isDirty: !utils_1.isEqual(state.originalValue, state.value), registerValidator: providerValue.registerValidator })));
            };
            return _this;
        }
    ...
    var InnerField = /** @class */ (function (_super) {
        ...
        function InnerField() {
            ...
            _this.collectProps = function () {
                var _a = _this.props, render = _a.render, component = _a.component, initialValue = _a.initialValue, registerValidator = _a.registerValidator, _b = _a.validation, validation = _b === void 0 ? emptyArray : _b, props = __rest(_a, ["render", "component", "initialValue", "registerValidator", "validation"]);
                return __assign({ name: _this.props.name, value: _this.props.value, originalValue: _this.props.originalValue, didBlur: _this.props.didBlur, touched: _this.props.touched, isDirty: _this.props.isDirty, isValid: validation.length === 0, messages: validation, submitCount: _this.props.submitCount }, props, { onBlur: _this.onBlur, onChange: _this.onChange });
            };
            return _this;
        }
        ...
        InnerField.prototype.componentWillUnmount = function () {
            // unregisterField()
        };
