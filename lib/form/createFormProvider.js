    ...
    return _a = /** @class */ (function (_super) {
            ...
            Form.prototype.touchField = function (fieldName) {
                if (!this.state.value[fieldName])
                    return;
                var value = utils_1.clone(this.state.value);
                value[fieldName] = fieldStateHelpers_1.touchField(value[fieldName]);
                this.setState(function (state) { return ({ value: value }); });
            };
            ...
            Form.prototype.untouchField = function (fieldName) {
                if (!this.state.value[fieldName])
                    return;
                var value = utils_1.clone(this.state.value);
                value[fieldName] = fieldStateHelpers_1.untouchField(value[fieldName]);
                this.setState(function (state) { return ({ value: value }); });
            };
            ...
            Form.prototype.registerField = function (fieldName, value, validators) {
                ...
                this.setState(function (s) {
                    ...
                    var field = state.value[fieldName];
                    var val = field ? field.value || value : value;
                    state.value[fieldName] = getInitialState_1.getInitialFieldState(val || value);
                    return state;
                });
            };
        ...
        _a.getDerivedStateFromProps = index_1.getGetDerivedStateFromProps(opts),
        _a;
    var _a;
}
