    ...
    return _a = /** @class */ (function (_super) {
            ...
            Form.prototype.registerField = function (fieldName, value, validators) {
                ...
                this.setState(function (_a) {
                    ...
                    return ({
                        fields: set(fields, fieldName, getInitialState_1.getInitialFieldState(value))
                    });
                });
            };
            ...
            Form.prototype.setFieldValue = function (fieldName, val) {
                ...
                this.setState(function (_a) {
                    var fields = _a.fields;
                    return ({
                        fields: set(fields, fieldName, index_1.setFieldValue(fields[fieldName], val))
                    });
                });
            };
            Form.prototype.touchField = function (fieldName) {
                ...
                this.setState(function (_a) {
                    var fields = _a.fields;
                    return ({
                        fields: set(fields, fieldName, fieldStateHelpers_1.touchField(fields[fieldName]))
                    });
                });
            };
            ...
            Form.prototype.untouchField = function (fieldName) {
                ...
                this.setState(function (_a) {
                    var fields = _a.fields;
                    return ({
                        fields: set(fields, fieldName, fieldStateHelpers_1.untouchField(fields[fieldName]))
                    });
                });
            };
            ...
            Form.prototype.onFieldBlur = function (fieldName) {
                ...
                this.setState(function (_a) {
                    var fields = _a.fields;
                    return ({
                        fields: set(fields, fieldName, index_1.blurField(fields[fieldName]))
                    });
                });
            };
