...
function wrapFormProvider(Provider, opts) {
    ...
    var _a = index_1.noops(), noopSubmit = _a.noopSubmit, noopOnFieldBlur = _a.noopOnFieldBlur, noopSetFieldValue = _a.noopSetFieldValue, noopValidateForm = _a.noopValidateForm, noopValidateField = _a.noopValidateField;
    return _b = /** @class */ (function (_super) {
            ...
            function Form() {
                ...
                _this.getProviderValue = function () {
                    return __assign({}, _this.state, { unload: _this.unload, submit: _this.submit, clearForm: _this.clearForm, forgetState: _this.forgetState, onFieldBlur: _this.onFieldBlur, validation: _this.validateForm(), setFieldValue: _this.setFieldValue, registerField: _this.registerField, registerValidator: _this.registerValidator });
                };
                return _this;
            }
