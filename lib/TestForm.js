...
var TTT = function (props) { return (React.createElement(Form, { initialValue: { name: 'stuart' } },
    ...
    React.createElement(Surname, { name: "surname", render: function (field) { return (React.createElement("input", { name: field.name, onChange: function (e) { return field.setFieldValue('surname', 'bourhill'); }, onBlur: field.onBlur, placeholder: "First Name" })); } }),
