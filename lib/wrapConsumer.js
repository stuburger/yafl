    ...
    return /** @class */ (function (_super) {
        ...
        function FormField() {
            ...
            _this._render = function (state) {
                ...
                var value = state.loaded ? state.value[name] : defaultFieldState;
                return (React.createElement(InnerField, __assign({}, value, { name: name, submit: state.submit, validators: validators, setFieldValue: state.setFieldValue, validationResult: state.validateField(name, value), registerValidator: state.registerValidator, render: render })));
            };
            return _this;
        }
...
function getInnerField() {
    return /** @class */ (function (_super) {
        ...
        InnerField.prototype.render = function () {
            var _a = this.props, render = _a.render, value = _a.value, isDirty = _a.isDirty, submit = _a.submit, validationResult = _a.validationResult;
            return render({
                value: value,
                isDirty: isDirty,
                submit: submit,
