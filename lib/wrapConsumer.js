    ...
    return /** @class */ (function (_super) {
        ...
        function FormField() {
            ...
            _this._render = function (_a) {
                ...
                return (React.createElement(InnerField, __assign({}, state, props, { name: name, state: state, render: render, component: component, validators: validators, submit: providerValue.submit, clearForm: providerValue.clearForm, submitCount: providerValue.submitCount, onFieldBlur: providerValue.onFieldBlur, validation: providerValue.validation[name], setFieldValue: providerValue.setFieldValue, isDirty: isEqual(state.originalValue, state.value), registerValidator: providerValue.registerValidator })));
            };
            return _this;
        }
    ...
    var InnerField = /** @class */ (function (_super) {
        ...
        function InnerField() {
            ...
            _this.collectProps = function () {
                var _a = _this.props, _b = _a.validation, validation = _b === void 0 ? emptyArray : _b, props = __rest(_a, ["validation"]);
