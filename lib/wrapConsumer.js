    ...
    var InnerField = /** @class */ (function (_super) {
        ...
        function InnerField() {
            ...
            _this.collectProps = function () {
                var _a = _this.props, validationResult = _a.validationResult, props = __rest(_a, ["validationResult"]);
                return __assign({}, props, { onBlur: _this.onBlur, onChange: _this.onChange, validation: validationResult });
            };
            return _this;
        }
